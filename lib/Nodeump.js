  ...
  _prototypeProperties(Nodeump, null, {
    exportData: {
      value: function exportData() {
        ...
        var connection = new this.Connection(this.config);
        return connection.getConnection().then(function (client) {
          var exporter = new _this.Exporter(client, _this.config.dataplan);
    ...
    importData: {
      value: function importData() {
        ...
        var connection = new this.Connection(this.config);
        return connection.getConnection().then(function (client) {
          var importer = new _this.Importer(client, _this.config.dataplan);
